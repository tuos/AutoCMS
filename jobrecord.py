"""Class for recording information about an AutoCMS test job.

JobRecord objects are primarily intended to be created by the logharvester
which parses output and submission logs to keep track of jobs. They are
stored in a dictionary which may be read by reporting modules.
"""
import re
